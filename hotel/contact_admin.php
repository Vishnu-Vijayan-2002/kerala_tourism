...
if(isset($_POST['submit'])){
 ...
 $qry = "INSERT INTO  contact (`name`,`message`,`subject`,`email`,`hotel_id`) VALUES('$name','$password','$phone','$email','$hotel_id')";
// $qry1 = "INSERT INTO login(`name`,`password`,`type`,`status`,`user_id`) VALUES('$name','$password','user','pending',(select max(id) from reg))";

echo $qry;

 if ($conn->query($qry) == TRUE){
    echo"<script> alert('successful'); window.location=(\"contact_admin.php\"); </script>";
