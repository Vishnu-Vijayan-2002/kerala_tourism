...
if( $_GET["pack_id"] || $_GET["user_id"] ) {
    ...
    if ($fetch['chk'] > 0) {
      ...
      echo"<script>  window.location=(\"payment.php?pack_id=$pid&user_id=$id&image=$image&price=$price&title=$title&desc=$desc&user_name=$user_name&user_email=$user_email&user_phone=$user_phone&hotel_id=$hotel_id\");</script>";
